...
typedef struct { complex s; } _cga;
channel complex8 _xLoader_uX_channel __attribute__((depth(256))) ;
channel complex8 _yLoader_uY_channel __attribute__((depth(256))) ;
channel complex _Z_uZ_2_channel[64] __attribute__((depth(0))) ;
 ...
 __address_space__X_serializer_mem_channel const complex *restrict _X_serializer_mem_channel)
{
 ...
 for (int _xLoader_s0_k = 0; _xLoader_s0_k < 0 + _0; _xLoader_s0_k++)
 {
  for (int _xLoader_s0_kk = 0; _xLoader_s0_kk < 0 + 64; _xLoader_s0_kk++)
  {
   int _1 = _addr_temp;
   int _2 = _1 * 8;
   complex8 _3 = {vload16(0, (__address_space__X_serializer_mem_channel float*)(_X_serializer_mem_channel + _2))};
...
__kernel void kernel_yLoader(
 const int _X_extent_0,
 __address_space__Y_serializer_mem_channel const complex *restrict _Y_serializer_mem_channel)
{
 int _addr_temp;
 _addr_temp = 0;
 ...
 for (int _yLoader_s0_k = 0; _yLoader_s0_k < 0 + _5; _yLoader_s0_k++)
 {
  for (int _yLoader_s0_kk = 0; _yLoader_s0_kk < 0 + 64; _yLoader_s0_kk++)
  {
   int _6 = _addr_temp;
   int _7 = _6 * 8;
   complex8 _8 = {vload16(0, (__address_space__Y_serializer_mem_channel float*)(_Y_serializer_mem_channel + _7))};
 ...
 const int _X_extent_0)
{
 ...
 for (int _uX_s0_k = 0; _uX_s0_k < 0 + _10; _uX_s0_k++)
 {
  for (int _uX_s0_kk = 0; _uX_s0_kk < 0 + 64; _uX_s0_kk++)
  {
   ...
   for (int _dummy_s0_l1 = 0; _dummy_s0_l1 < 0 + 63; _dummy_s0_l1++)
   {
    ...
    complex _16 = _uZ_1_shreg[_14];
    _uZ_1_shreg[_13] = _16;
    (void)_16;
   } // for _dummy_s0_l1
   complex _17 = _uZ_1_temp;
   _uZ_1_shreg[0] = _17;
   (void)_17;
   complex8 __18 = read_channel_intel(_xLoader_uX_channel);
   _uX_shreg = __18;
   (void)__18;
   complex8 __19 = read_channel_intel(_yLoader_uY_channel);
   _uY_shreg = __19;
   (void)__19;
   complex _20;
   bool _21 = _uX_s0_k == 0;
   if (_21)
   {
    complex _22 = (complex)(ADD_UINT64_T_SUFFIX(0));
    _20 = _22;
   } // if _21
   else
   {
    complex _24 = _uZ_1_shreg[0];
    complex _25 = __fpga_reg(_24);
    _20 = _25;
   } // if _21 else
   complex _26 = _20;
   ...
   {
    complex _27 = _uZ_1_shreg_temp;
    complex _29 = _uX_shreg.s[_uX_s0_kkk];
    complex _31 = _uY_shreg.s[_uX_s0_kkk];
    complex _32 = (complex) {_29.s0 * _31.s0 - _29.s1 * _31.s1, _29.s0 * _31.s1 + _29.s1 * _31.s0};
    complex _33 = _27 + _32;
    ...
    if (_35)
    {
     complex _36 = _uZ_1_shreg_temp;
     complex _37 = __fpga_reg(_36);
     _uZ_1_shreg_temp = _37;
    } // if _35
   } // for _uX_s0_kkk
   complex _38 = _uZ_1_shreg_temp;
   _uZ_1_shreg[0] = _38;
   (void)_38;
   #pragma unroll
   for (int _uX_s0_kkk = 0; _uX_s0_kkk < 0 + 8; _uX_s0_kkk++)
 ...
 {
  int _48 = _addr_temp;
  complex _50 = _Z_uZ_2_temp_shreg[_48];
  complex _51;
  bool _52 = _uZ_2_s0_kk == 0;
  if (_52)
  {
   complex _53 = (complex)(ADD_UINT64_T_SUFFIX(0));
   _51 = _53;
  } // if _52
  else
  {
   int _54 = _uZ_2_s0_kk + -1;
   complex _56 = _uZ_2_shreg[_54];
   _51 = _56;
  } // if _52 else
  complex _57 = _51;
  complex _58 = _50 + _57;
