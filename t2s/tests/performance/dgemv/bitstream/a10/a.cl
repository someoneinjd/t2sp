...
typedef union { double s[32]; double16 v[2]; } _aLoader_channel_array_t;
channel _aLoader_channel_array_t _aLoader_channel __attribute__((depth(256))) ;
channel double _xLoader_channel __attribute__((depth(256))) ;
channel double _xFeeder_channel __attribute__((depth(256))) ;
typedef struct { double s[32]; } _V_channel_array_t;
...
__kernel void kernel_aLoader(
 ...
 __address_space__A_serializer const double *restrict _A_serializer_1,
 __address_space__A_serializer const double *restrict _A_serializer_2)
{
 int _addr_temp = 0;
 ...
 for (int _aLoader_s0_i = 0; _aLoader_s0_i < 0 + _0; _aLoader_s0_i++)
 {
  ...
  {
   for (int _aLoader_s0_kk_ii = 0; _aLoader_s0_kk_ii < 0 + 32 * 32; _aLoader_s0_kk_ii++)
   {
    _aLoader_channel_array_t _aLoader_channel_array;
    int _2 = _addr_temp;
    int _3 = _2 * 16;
    _aLoader_channel_array.v[0] = vload16(0, (__address_space__A_serializer double*)(_A_serializer_1 + _3));
    _aLoader_channel_array.v[1] = vload16(0, (__address_space__A_serializer double*)(_A_serializer_2 + _3));
 ...
 for (int _xLoader_s0_i = 0; _xLoader_s0_i < 0 + _15; _xLoader_s0_i++)
 {
  ...
  for (int _xLoader_s0_k = 0; _xLoader_s0_k < 0 + _16; _xLoader_s0_k++)
  {
   for (int _xLoader_s0_kk = 0; _xLoader_s0_kk < 0 + 32; _xLoader_s0_kk++)
   {
    ...
    int _19 = _18 * 32;
    int _20 = _17 % _19;
    double _21 = _X_serializer_mem_channel[_20];
 ...
 const int _A_extent_1)
{
 ...
 double __attribute__((memory, numbanks(32), singlepump, numwriteports(1), numreadports(1))) _xFeeder_buffer__0_ibuffer[2][32];
 ...
 for (int _xFeeder_s0_outermost_loop = 0; _xFeeder_s0_outermost_loop < 0 + _30; _xFeeder_s0_outermost_loop++)
 {
  ...
  if (_36)
  {
   double __37 = read_channel_intel(_xLoader_channel);
  ...
  if (_48)
  {
   ...
   int _54 = _49 >> 5;
   int _55 = _54 & 31;
   double _56 = _xFeeder_buffer__0_ibuffer[_53][_55];
 ...
 const int _A_extent_1)
{
 ...
 for (int _uA_s0_i = 0; _uA_s0_i < 0 + _217; _uA_s0_i++)
 {
  ...
  {
   for (int _uA_s0_kk_ii = 0; _uA_s0_kk_ii < 0 + 32 * 32; _uA_s0_kk_ii++)
   {
    #pragma unroll
    for (int _dummy_s0_iii = 0; _dummy_s0_iii < 0 + 32; _dummy_s0_iii++)
    {
     double _220 = _uZ_shreg[31][_dummy_s0_iii];
     ...
     for (int _dummy__1_s0_l0 = 0; _dummy__1_s0_l0 < 0 + 31; _dummy__1_s0_l0++)
     {
      ...
      double _224 = _uZ_shreg[_222][_dummy_s0_iii];
      _uZ_shreg[_221][_dummy_s0_iii] = _224;
      (void)_224;
     } // for _dummy__1_s0_l0
     double _225 = _uZ_temp[_dummy_s0_iii];
    ...
    double _xFeeder_channel_array = read_channel_intel(_xFeeder_channel);
    #pragma unroll
    for (int _uA_s0_iii = 0; _uA_s0_iii < 0 + 32; _uA_s0_iii++)
    {
     double __227 = _aLoader_channel_array.s[_uA_s0_iii];
     ...
     if (_229)
     {
      double __230 = _xFeeder_channel_array;
      _228 = __230;
     } // if _229
     else
     {
      double _232 = _uX_shreg;
      _228 = _232;
     } // if _229 else
     double _233 = _228;
     _uX_shreg = _233;
     (void)_233;
     double _235 = _uX_shreg;
     double _236 = __fpga_reg(__fpga_reg(_235));
     _uX_shreg = _236;
     (void)_236;
     double _237;
     ...
     if (_241)
     {
      double _242 = float_from_bits(0 /* 0 */);
      _237 = _242;
     } // if _241
     else
     {
      double _244 = _uZ_shreg[0][_uA_s0_iii];
      _237 = _244;
     } // if _241 else
     double _245 = _237;
     double _247 = _uA_shreg[_uA_s0_iii];
     double _249 = _uX_shreg;
     double _250 = _247 * _249;
     double _251 = _245 + _250;
     ...
     if (_257)
     {
      double _259 = _uZ_shreg[0][_uA_s0_iii];
 ...
 __address_space__unloader_mem_channel double *restrict _unloader_mem_channel)
{
 ...
 int _addr_temp;
 _addr_temp = 0;
 int _160 = _A_extent_1 >> 10;
 for (int _unloader_s0_i = 0; _unloader_s0_i < 0 + _160; _unloader_s0_i++)
 {
  for (int _unloader_s0_ii = 0; _unloader_s0_ii < 0 + 32; _unloader_s0_ii++)
  {
   _V_channel_array_t __161 = read_channel_intel(_V_channel);
   _V_channel_array = __161;
   (void)__161;
   for (int _unloader_s0_iii = 0; _unloader_s0_iii < 0 + 32; _unloader_s0_iii++)
   {
    double __162 = _V_channel_array.s[_unloader_s0_iii];
    int _163 = _addr_temp;
    _unloader_mem_channel[_163] = __162;
    int _164 = _addr_temp;
    int _165 = _164 + 1;
    _addr_temp = _165;
