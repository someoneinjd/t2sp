...
channel float16 _ALoader_T_channel __attribute__((depth(256))) ;
typedef struct { float16 s[8]; } _AFeeder_T_channel_array_t;
channel _AFeeder_T_channel_array_t _AFeeder_T_channel __attribute__((depth(256))) ;
channel float16 _BLoader_T_channel __attribute__((depth(256))) ;
typedef struct { float16 s[8]; } _BFeeder_T_channel_array_t;
     ...
     for (int _ALoader_s0_ii = 0; _ALoader_s0_ii < 0 + 16; _ALoader_s0_ii++)
     {
      for (int _ALoader_s0_iii = 0; _ALoader_s0_iii < 0 + 8; _ALoader_s0_iii++)
      {
       ...
       if (_16)
       {
        ...
        if (_20)
        {
         int _21 = _ALoader_s0_iii*16 + _ALoader_s0_ii*128 + _ALoader_s0_kk*2048;
         int _22 = _21 + _ALoader_s0_k*16384;
         int _23 = _22 + _ALoader_s0_i*16384*_4;
         float16 _33 = vload16(0, (__address_space__ASerializer_mem_channel float*)_ASerializer_mem_channel + _23);
         _18 = _33;
        } // if _20
        else
        {
...
)
{
 ...
 while(1)
 {
  ...
  if (_45)
  {
   float16 __46 = read_channel_intel(_ALoader_channel);
  ...
  for (int _AFeeder_s0_buf = 0; _AFeeder_s0_buf < 0 + 8; _AFeeder_s0_buf++)
  {
   ...
   if (_100)
   {
    ...
    int _113 = _105 >> 4;
    int _114 = _113 & 15;
    float16 _115 = _AFeeder_DB_0_ibuffer[_111][_112][_114][_AFeeder_s0_buf];
      ...
      for (int _BLoader_s0_jjj = 0; _BLoader_s0_jjj < 0 + 8; _BLoader_s0_jjj++)
      {
       ...
       if (_141)
       {
        ...
        if (_144)
        {
         ...
         float16 _153 = vload16(0, (__address_space__BSerializer_mem_channel float*)_BSerializer_mem_channel + _20);
         _142 = _153;
        } // if _144
        else
        {
...
)
{
 ...
 for (int _BFeeder_s0_iii_init = 0; _BFeeder_s0_iii_init < 0 + 8; _BFeeder_s0_iii_init++)
 {
  ...
  if (_159)
  {
   uint _160 = (uint)(ADD_UINT64_T_SUFFIX(1024));
   _BFeeder_cycle_temp = _160;
  } // if _159
 } // for _BFeeder_s0_iii_init
 while(1)
 {
  uint _161 = (uint)(ADD_UINT64_T_SUFFIX(1024));
  ...
  if (_165)
  {
   float16 __166 = read_channel_intel(_BLoader_channel);
  ...
  for (int _BFeeder_s0_buf = 0; _BFeeder_s0_buf < 0 + 8; _BFeeder_s0_buf++)
  {
   ...
   if (_167)
   {
    float16 _168 = _BFeeder_in_v_temp;
   ...
   {
    float16 _171 = _BFeeder_value_shreg;
   ...
   float16 _175 = _BFeeder_value_shreg;
   float16 _176 = __fpga_reg(__fpga_reg(_175));
   ...
   (void)_179;
   uint _180 = (uint)(ADD_UINT64_T_SUFFIX(1024));
   ...
   if (_185)
   {
    ...
    uint _189 = _187 & _188;
    uint _190 = (uint)(ADD_UINT64_T_SUFFIX(1024));
    uint _191 = _189 - _190;
    ...
    if (_195)
    {
     float16 _197 = _BFeeder_value_shreg;
     ...
     uint _207 = _199 & _206;
     uint _208 = (uint)(ADD_UINT64_T_SUFFIX(1024));
     uint _209 = _207 - _208;
     int _210 = (int)(_209);
     int _211 = _210 >> 7;
     int _213 = _210 >> 3;
   ...
   if (_220)
   {
    ...
    int _232 = _225 >> 8;
    int _233 = _225 & 15;
    float16 _234 = _BFeeder_DB_0_ibuffer[_231][_232][_233][_BFeeder_s0_buf];
      ...
      for (int _X_s0_jj = 0; _X_s0_jj < 0 + 16; _X_s0_jj++)
      {
       ...
       for (int _X_s0_iii = 0; _X_s0_iii < 0 + 8; _X_s0_iii++)
       {
        ...
        for (int _X_s0_jjj = 0; _X_s0_jjj < 0 + 8; _X_s0_jjj++)
        {
         ...
         if (_261)
         {
          float16 __262 = _AFeeder_channel_array.s[_X_s0_iii];
          _260 = __262;
         } // if _261
         else
         {
          float16 _264 = _X_shreg[_X_s0_iii];
          _260 = _264;
         } // if _261 else
         float16 _265 = _260;
         _X_shreg[_X_s0_iii] = _265;
         (void)_265;
         float16 _267 = _X_shreg[_X_s0_iii];
         ...
         if (_270)
         {
          float16 __271 = _BFeeder_channel_array.s[_X_s0_jjj];
          _269 = __271;
         } // if _270
         else
         {
          float16 _273 = _Y_shreg[_X_s0_jjj];
          _269 = _273;
         } // if _270 else
         float16 _274 = _269;
         _Y_shreg[_X_s0_jjj] = _274;
         (void)_274;
         float16 _276 = _Y_shreg[_X_s0_jjj];
     ...
     for (int _ALoader_T_s0_ii = 0; _ALoader_T_s0_ii < 0 + 16; _ALoader_T_s0_ii++)
     {
      for (int _ALoader_T_s0_iii = 0; _ALoader_T_s0_iii < 0 + 8; _ALoader_T_s0_iii++)
      {
       ...
       if (_360)
       {
        ...
        if (_363)
        {
         int _18 = _ALoader_T_s0_iii*16 + _ALoader_T_s0_ii*128 + _ALoader_T_s0_kk*2048;
         int _19 = _18 + _ALoader_T_s0_k*16384;
         int _20 = _19 + _ALoader_T_s0_i*16384*_348;
         float16 _372 = vload16(0, (__address_space__ASerializer_T_mem_channel float*)_ASerializer_T_mem_channel + _20);
         _361 = _372;
        } // if _363
        else
        {
...
)
{
 ...
 float16 _AFeeder_T_value_shreg;
 uint _AFeeder_T_time_stamp_shreg;
 float16 _AFeeder_T_in_v_temp;
 uint _AFeeder_T_cycle_temp;
 float16 __attribute__((memory, numbanks(8), singlepump, numwriteports(1), numreadports(1))) _AFeeder_T_DB_0_ibuffer[2][8][16][8];
 #pragma unroll
 for (int _AFeeder_T_s0_jjj_init = 0; _AFeeder_T_s0_jjj_init < 0 + 8; _AFeeder_T_s0_jjj_init++)
 {
  ...
  if (_378)
  {
   uint _379 = (uint)(ADD_UINT64_T_SUFFIX(1024));
   _AFeeder_T_cycle_temp = _379;
  } // if _378
 } // for _AFeeder_T_s0_jjj_init
 while(1)
 {
  uint _380 = (uint)(ADD_UINT64_T_SUFFIX(1024));
  ...
  if (_384)
  {
   float16 __385 = read_channel_intel(_ALoader_T_channel);
  ...
  for (int _AFeeder_T_s0_buf = 0; _AFeeder_T_s0_buf < 0 + 8; _AFeeder_T_s0_buf++)
  {
   ...
   if (_386)
   {
    float16 _387 = _AFeeder_T_in_v_temp;
   ...
   {
    float16 _390 = _AFeeder_T_value_shreg;
   ...
   float16 _394 = _AFeeder_T_value_shreg;
   float16 _395 = __fpga_reg(__fpga_reg(_394));
   ...
   (void)_398;
   uint _399 = (uint)(ADD_UINT64_T_SUFFIX(1024));
   ...
   if (_404)
   {
    ...
    uint _408 = _406 & _407;
    uint _409 = (uint)(ADD_UINT64_T_SUFFIX(1024));
    uint _410 = _408 - _409;
    ...
    if (_414)
    {
     float16 _416 = _AFeeder_T_value_shreg;
     ...
     uint _426 = _418 & _425;
     uint _427 = (uint)(ADD_UINT64_T_SUFFIX(1024));
     uint _428 = _426 - _427;
     int _429 = (int)(_428);
     int _430 = _429 >> 7;
     int _432 = _429 >> 3;
   ...
   if (_439)
   {
    ...
    int _451 = _444 >> 8;
    int _452 = _444 & 15;
    float16 _453 = _AFeeder_T_DB_0_ibuffer[_450][_451][_452][_AFeeder_T_s0_buf];
    ...
    for (int _BLoader_T_s0_kk = 0; _BLoader_T_s0_kk < 0 + 8; _BLoader_T_s0_kk++)
    {
     for (int _BLoader_T_s0_jj = 0; _BLoader_T_s0_jj < 0 + 16; _BLoader_T_s0_jj++)
     {
      for (int _BLoader_T_s0_jjj = 0; _BLoader_T_s0_jjj < 0 + 8; _BLoader_T_s0_jjj++)
      {
       ...
       bool _470 = _468 && _469;
       int _477 = _B_extent_0 >> 7;
       bool _478 = _BLoader_T_s0_j < _477;
       bool _479 = _470 || _478;
       if (_479)
       {
        float16 _481;
        int _482 = _B_extent_0 >> 7;
        bool _483 = _BLoader_T_s0_j < _482;
        if (_483)
        {
         int _18 = _BLoader_T_s0_jjj*16 + _BLoader_T_s0_jj*128 + _BLoader_T_s0_kk*2048;
         int _19 = _18 + _BLoader_T_s0_k*16384;
         int _20 = _19 + _BLoader_T_s0_j*16384*_467;
         float16 _496 = vload16(0, (__address_space__BSerializer_T_mem_channel float*)_BSerializer_T_mem_channel + _20);
         _481 = _496;
        } // if _483
        else
        {
         float _497 = float_from_bits(0 /* 0 */);
         float16 _498 = _497;
         _481 = _498;
        } // if _483 else
        float16 _499 = _481;
...
)
{
 ...
 float16 _BFeeder_T_value_shreg;
 uint _BFeeder_T_time_stamp_shreg;
 float16 _BFeeder_T_in_v_temp;
 uint _BFeeder_T_cycle_temp;
 float16 __attribute__((memory, numbanks(8), singlepump, numwriteports(1), numreadports(1))) _BFeeder_T_DB_0_ibuffer[2][8][16][8];
 #pragma unroll
 for (int _BFeeder_T_s0_iii_init = 0; _BFeeder_T_s0_iii_init < 0 + 8; _BFeeder_T_s0_iii_init++)
 {
  ...
  if (_502)
  {
   uint _503 = (uint)(ADD_UINT64_T_SUFFIX(1024));
   _BFeeder_T_cycle_temp = _503;
  } // if _502
 } // for _BFeeder_T_s0_iii_init
 while(1)
 {
  uint _504 = (uint)(ADD_UINT64_T_SUFFIX(1024));
  ...
  if (_508)
  {
   float16 __509 = read_channel_intel(_BLoader_T_channel);
  ...
  for (int _BFeeder_T_s0_buf = 0; _BFeeder_T_s0_buf < 0 + 8; _BFeeder_T_s0_buf++)
  {
   ...
   if (_510)
   {
    float16 _511 = _BFeeder_T_in_v_temp;
   ...
   {
    float16 _514 = _BFeeder_T_value_shreg;
   ...
   float16 _518 = _BFeeder_T_value_shreg;
   float16 _519 = __fpga_reg(__fpga_reg(_518));
   ...
   (void)_522;
   uint _523 = (uint)(ADD_UINT64_T_SUFFIX(1024));
   ...
   if (_528)
   {
    ...
    uint _532 = _530 & _531;
    uint _533 = (uint)(ADD_UINT64_T_SUFFIX(1024));
    uint _534 = _532 - _533;
    uint _535 = (uint)(ADD_UINT64_T_SUFFIX(7));
    uint _536 = _534 & _535;
    int _537 = (int)(_536);
    bool _538 = _BFeeder_T_s0_buf == _537;
    if (_538)
    {
     float16 _540 = _BFeeder_T_value_shreg;
     ...
     uint _550 = _542 & _549;
     uint _551 = (uint)(ADD_UINT64_T_SUFFIX(1024));
     uint _552 = _550 - _551;
     int _553 = (int)(_552);
     int _554 = _553 >> 7;
     int _556 = _553 >> 3;
   ...
   if (_563)
   {
    ...
    int _576 = _568 >> 4;
    int _577 = _576 & 15;
    float16 _578 = _BFeeder_T_DB_0_ibuffer[_574][_575][_577][_BFeeder_T_s0_buf];
 ...
 const int _B_extent_0)
{
 ...
 // produce Y_T
 float16 _Y_T_shreg[8];
 float _Z_T_temp[8][8];
 float _Z_temp[8][8];
 // produce X_T
 float16 _X_T_shreg[8];
      ...
      for (int _X_T_s0_ii = 0; _X_T_s0_ii < 0 + 16; _X_T_s0_ii++)
      {
       ...
       for (int _X_T_s0_jjj = 0; _X_T_s0_jjj < 0 + 8; _X_T_s0_jjj++)
       {
        ...
        for (int _X_T_s0_iii = 0; _X_T_s0_iii < 0 + 8; _X_T_s0_iii++)
        {
         ...
         if (_605)
         {
          float16 __606 = _AFeeder_T_channel_array.s[_X_T_s0_iii];
          _604 = __606;
         } // if _605
         else
         {
          float16 _608 = _X_T_shreg[_X_T_s0_iii];
          _604 = _608;
         } // if _605 else
         float16 _609 = _604;
         _X_T_shreg[_X_T_s0_iii] = _609;
         (void)_609;
         float16 _611 = _X_T_shreg[_X_T_s0_iii];
         float16 _612 = __fpga_reg(__fpga_reg(_611));
         ...
         if (_614)
         {
          float16 __615 = _BFeeder_T_channel_array.s[_X_T_s0_jjj];
          _613 = __615;
         } // if _614
         else
         {
          float16 _617 = _Y_T_shreg[_X_T_s0_jjj];
          _613 = _617;
         } // if _614 else
         float16 _618 = _613;
         _Y_T_shreg[_X_T_s0_jjj] = _618;
         (void)_618;
         float16 _620 = _Y_T_shreg[_X_T_s0_jjj];
         float16 _621 = __fpga_reg(__fpga_reg(_620));
         ...
         #pragma unroll
         for (int _X_T_s0_kkk = 0; _X_T_s0_kkk < 0 + 16; _X_T_s0_kkk++)
         {
