...
typedef struct { complexd4 s[8]; } _AFeeder_channel_array_t;
     ...
     for (int _ALoader_s0_ii = 0; _ALoader_s0_ii < 0 + 8; _ALoader_s0_ii++)
     {
      for (int _ALoader_s0_iii = 0; _ALoader_s0_iii < 0 + 8; _ALoader_s0_iii++)
      {
       ...
       if (_16)
       {
        ...
        if (_20)
        {
         int _21 = _ALoader_s0_iii * 4 + _ALoader_s0_ii * 32 + _ALoader_s0_kk * 256;
...
)
{
 ...
 complexd4 __attribute__((memory, numbanks(8), singlepump, numwriteports(1), numreadports(1))) _AFeeder_DB_0_ibuffer[2][16][8][8];
 #pragma unroll
      ...
      for (int _BLoader_s0_jjj = 0; _BLoader_s0_jjj < 0 + 2; _BLoader_s0_jjj++)
      {
       ...
       if (_141)
       {
        ...
        if (_144)
        {
         ...
         int _23 = _22 + _BLoader_s0_j * 4096 * _128;
 ...
 const int _B_extent_0)
{
 ...
 _AFeeder_channel_array_t _AFeeder_channel_array;
 // produce Z
 complexd _Z_shreg[256][2][8];
 complexd _Z_pipe_shreg[2][1793];
 // produce Y
 complexd4 _Y_shreg[2];
 complexd _Z_temp[2][8];
 // produce X
 complexd4 _X_shreg[8];
  ...
  for (int _X_s0_j = 0; _X_s0_j < 0 + _246; _X_s0_j++)
  {
   ...
   for (int _X_s0_k = _X_s0_i; _X_s0_k < _X_s0_i + _248; _X_s0_k++)
   {
    for (int _X_s0_kk_ii_jj = 0; _X_s0_kk_ii_jj < 0 + 4096; _X_s0_kk_ii_jj++)
    {
       ...
       bool _309 = ((_X_s0_kk_ii_jj >> 5) & 0x7) == 0;
       bool _310 = _308 && _309;
       ...
       bool _316 = _314 && _315;
       int _317 = _A_extent_1 >> 6;
       bool _318 = _X_s0_i < _317;
       bool _319 = _316 && _318;
       if (_319)
       {
 ...
 __address_space__unloader_mem_channel complexd *restrict _unloader_mem_channel)
{
 ...
 for (int _unloader_s0_i = 0; _unloader_s0_i < 0 + _343; _unloader_s0_i++)
 {
  ...
  for (int _unloader_s0_j = 0; _unloader_s0_j < 0 + _344; _unloader_s0_j++)
  {
   for (int _unloader_s0_iii_ii_jj = 0; _unloader_s0_iii_ii_jj < 0 + 2048; _unloader_s0_iii_ii_jj++)
   {
      complexd2 __345 = read_channel_intel(_Out_channel);
      int _346 = _addr_temp;
      int _347 = _346 * 2;
      vstore4(__345.t, 0, (__address_space__unloader_mem_channel double*)(_unloader_mem_channel + _347));
      int _348 = _addr_temp;
      int _349 = _348 + 1;
      _addr_temp = _349;
