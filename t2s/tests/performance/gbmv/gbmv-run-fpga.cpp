...
int main()
{
    ...
    Halide::Runtime::Buffer<float> a(TOTAL_J, TOTAL_I), x(TOTAL_J), y(TOTAL_I + Ku);
    // cout << "TOTAL_I: " << TOTAL_I << endl;
    // cout << "TOTAL_J: " << TOTAL_J << endl;
    ...
    cout << "extendedI: " << extendedI << endl;
    Halide::Runtime::Buffer<float> o(III, II, extendedI);
    gbmv(alpha, beta, bandedA, x, y, o);

#ifdef TINY
    // Validate the results
    for (int i = 0; i < extendedI; i++)
        for (int ii = 0; ii < II; ii++)
            for (int iii = 0; iii < III; iii++) {
                // printf("verify %d %f\n", i * 2 + iii, o(0, iii, ii, i));
                int total_i = iii + III * ii + III * II * i - Ku;
                ...
                for (int j = 0; j < TOTAL_J; j++) {
                    ...
                    golden += a(j, total_i) * x(j);
                }
                golden = golden * alpha + y(total_i + Ku) * beta;
