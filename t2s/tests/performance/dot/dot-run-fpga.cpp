...
int main()
{
    ...
    Halide::Runtime::Buffer<float> x(TOTAL_K), y(TOTAL_K);
    ...
    Halide::Runtime::Buffer<float> o(1);
    dot(x, y, o);
    ...
    float number_ops = 2 * (float)(K * K) * 2; // Total operations (GFLOP for GEMV), independent of designs
    float number_bytes = (float)(KK * K) * 2 * 4;
